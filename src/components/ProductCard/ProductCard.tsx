                ...
                {itemInCart ? (
                    <>
                        <fieldset className={[styles.quantityButtons, styles.cartPill].join(' ')}>
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="2" viewBox="0 0 10 2" aria-hidden="true"><path d="M0 .375h10v1.25H0V.375Z" /></svg>                            </button>
                            <span>{quantity}</span>
                            <button onClick={addItemToCart}
                                aria-label={t(`ariaLabels.increaseQuantity`)}
                                className={styles.quantityIcon}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" aria-hidden="true"><path d="M10 4.375H5.625V0h-1.25v4.375H0v1.25h4.375V10h1.25V5.625H10v-1.25Z" /></svg>
                            </button>
                        </fieldset>
                    </>
                )
